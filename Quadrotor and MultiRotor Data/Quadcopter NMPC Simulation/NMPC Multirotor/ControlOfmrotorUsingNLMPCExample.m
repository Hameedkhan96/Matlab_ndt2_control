...
nlobj.Model.StateFcn = "mrotorStateFcn";
nlobj.Jacobian.StateFcn = @mrotorStateJacobianFcn;
...
nlobj.MV = struct('Min',{0;0;0;0;0;0},'Max',{12;12;12;12;12;12});
...
for k = 1:(Duration/Ts)
    ...
    yref = mrotorReferenceTrajectory(t);
    ...
    lastMV = uk;
    % Update states.
    ODEFUN = @(t,xk) mrotorStateFcn(xk,uk);
